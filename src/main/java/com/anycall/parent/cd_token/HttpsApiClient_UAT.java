...
package com.anycall.parent.cd_token;
...
public class HttpsApiClient_UAT extends ApacheHttpClient{
    ...
    public void 小程序创建报修单(String faultDescription , String repairSource , String reportTime , String systemNumCode , String reportManTel , String reportMan , String soundUrls , String shopCode , String photographUrls , String idToken , String soundLength , ApiCallback callback) {
    ...
    public void 小程序修改密码(String idToken , String oldPwd , String newPwd , ApiCallback callback) {
